...
# Función para manejar números pulsados en la calculadora
def numeroPulsado(n):
    global numero
    global exc
    if exc==True:
...
# Función para realizar la operación 1/x (inverso)
def onediv():
    global numero
    global resultado
    global exc
...
# Función para manejar la memoria
def memo():
    global resultado
    global memoria
    global numero
...
# Función para manejar funciones trigonométricas y otras funciones matemáticas
def funcis(f):
    global numero
    global resultado
    global exc
...
# Función para agregar una coma al número
def comas():
    global numero
...
# Función para borrar el último dígito del número
def clear_error():
    global numero
...
# Función para mostrar el valor de pi en la pantalla
def pee():
    global numero
    global exc
    if exc==True:
...
# Funcion para gestionar la entrada de los operadores
def calculo(o):
    global resultado
    global numero
    global primr
...
# Función para realizar la operación final al presionar el botón '='
def result():
    global numero
    global resultado
    global prev_sign
...
# Configuración de la pantalla y botones en la interfaz gráfica
t=[]
Entry(ventana,font=('Arial',23,'bold'),textvariable=numeroPantalla,width=21,bd=2,bg="PaleGreen3",justify="right").place(x=1,y=30)

# Botones
Button(ventana,text="7",width=7,fg="white",bg="#666",height=2,command=lambda:numeroPulsado("7")).place(x=4,y=180)
Button(ventana,text="8",width=7,fg="white",bg="#666",height=2,command=lambda:numeroPulsado("8")).place(x=78,y=180)
Button(ventana,text="9",width=7,fg="white",bg="#666",height=2,command=lambda:numeroPulsado("9")).place(x=152,y=180)
Button(ventana,text="CE",width=7,bg="#FF3B30",height=2,command=clear_error).place(x=227,y=180)
Button(ventana,text="C",width=7,bg="#FF3B30",height=2,command=clear).place(x=302,y=180)
Button(ventana,text="4",width=7,fg="white",bg="#666",height=2,command=lambda:numeroPulsado("4")).place(x=4,y=238)
Button(ventana,text="5",width=7,fg="white",bg="#666",height=2,command=lambda:numeroPulsado("5")).place(x=78,y=238)
Button(ventana,text="6",width=7,fg="white",bg="#666",height=2,command=lambda:numeroPulsado("6")).place(x=152,y=238)
Button(ventana,text="x",width=7,fg="white",bg="#FF9500",height=2,command=lambda:calculo("*")).place(x=227,y=238)
Button(ventana,text="√",width=7,fg="white",bg="#666",height=2,command=raiz_cuadrada).place(x=78,y=354)
Button(ventana,text="1",width=7,fg="white",bg="#666",height=2,command=lambda:numeroPulsado("1")).place(x=4,y=296)
Button(ventana,text="2",width=7,fg="white",bg="#666",height=2,command=lambda:numeroPulsado("2")).place(x=78,y=296)
Button(ventana,text="3",width=7,fg="white",bg="#666",height=2,command=lambda:numeroPulsado("3")).place(x=152,y=296)
Button(ventana,text="+",width=7,fg="white",bg="#FF9500",height=2,command=lambda:calculo("+")).place(x=227,y=296)
Button(ventana,text="-",width=7,fg="white",bg="#FF9500",height=2,command=lambda:calculo("-")).place(x=302,y=296)
Button(ventana,text="0",width=7,fg="white",bg="#666",height=2,command=lambda:numeroPulsado("0")).place(x=4,y=354)
Button(ventana,text="/",width=7,fg="white",bg="#FF9500",height=2,command=lambda:calculo("/")).place(x=302,y=238)
Button(ventana,text=".",width=7,fg="white",bg="#666",height=2,command=comas).place(x=152,y=354)
Button(ventana,text="EXP",width=7,fg="white",bg="gray6",height=2,command=lambda:calculo("**")).place(x=227,y=354)
Button(ventana,text="=",width=7,fg="white",bg="#FF9500",height=2,command=result).place(x=302,y=354)
...
exit_button = Button(ventana, text='Salir', width=6, height=1, fg='black', bg='#888', command=ventana.quit).place(x=0, y=0)
#exit_button.pack()
